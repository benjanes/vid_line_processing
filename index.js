// ffmpeg -i title31.mp4 -i song2.mp3 -shortest -c:v copy -c:a aac -b:a 14.4k newvid.mp4
...
processSound(`${__dirname}/src/song2.mp3`, fps, startTime, endTime, (channel1Data, channel2Data) => {
  ...
  // for (let i = 1; i < 2; i++) {
    ...
    processImgNoColor(`${__dirname}/in_img/out${imgNumber}.png`, `${__dirname}/out_img/${imgNumber}.png`, channel1Data[i], channel2Data[i]);
  }
});
